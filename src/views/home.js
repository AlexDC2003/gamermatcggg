      ...
      <div data-role="Header" className="home-header-container">
        ...
        <div data-type="MobileMenu" className="home-mobile-menu">
          ...
          <div className="home-mid">
            ...
            <span className="home-text15">Jobs</span>
            <span className="home-text16">More</span>
          </div>
      ...
      <div className="home-main">
        ...
        <div className="home-container07">
          <div className="home-hero">
            <h1 className="home-text17">Gamermatch.GG</h1>
            <img
              alt="image"
              src="/playground_assets/fortnite-ruby-skin-featured-800h.png"
              ...
              <div className="home-hero1">
                <div className="home-container09">
                  <span className="home-text23">
                    Compete in Head-to-head matches, where money is on the line.
                    ur basically an ez clap and this is defo not a placeholder
                  </span>
      ...
      <div className="home-clients">
        ...
        <div className="home-stats">
          <div className="home-stat">
            ...
            <span className="home-text27">Played Matches</span>
            <span className="home-text28">
              Lorem ipsum dolor sit amet, consectetur adipiscing.
            </span>
          </div>
          <div className="home-stat1">
            <h1 className="home-text29">369</h1>
            <span className="home-text30">
              <span className="home-text31">Money Withdrawn</span>
              <br></br>
            </span>
          ...
          <div className="home-stat2">
            <h1 className="home-text34">24/7</h1>
            <span className="home-text35">Support</span>
        ...
        <footer className="home-footer">
          ...
          <div className="home-icon-group">
            ...
            <svg viewBox="0 0 602.2582857142856 1024" className="home-icon19">
